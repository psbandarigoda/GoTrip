        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="single-place mb-30">
              <div class="place-img">
                <img src=<?php  echo $row['pacImage'] ?> alt="">
              </div>
              <div class="place-cap">
                <div class="place-cap-top">
                  <span><i class="fas fa-star"></i><span>8.0 Superb</span> </span>
                  <h3><a href="#"><?php  echo $row['pacName'] ?></a></h3>
                  <p><?php  echo $row['pacDetails'] ?></p>
                  <p class="dolor">$<?php  echo $row['pacPrice'] ?> <span>/ Per Person</span>
                    <span style="float: right;"><button class="btn genric-btn small">
                        <a href="bookingPackage.php?id=<?php echo $row['id'] ?>">
                          booking</button></a></span></p>
                </div>
                <div class="place-cap-bottom">
                  <ul>
                    <li><i class="far fa-clock"></i><?php  echo $row['pacDays'] ?> Days</li>
                    <li><i class="fas fa-map-marker-alt"></i><?php  echo $row['pacLoaction'] ?></li>
                    <li><i class="fas fa-check-circle"></i><?php  echo $row['pacAvailability'] ?> More Booking Available </li>
                  </ul>
                </div>
              </div>
            </div>
