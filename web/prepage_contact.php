                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        ...
                                        <li><a href="index.php">Home</a></li>
                                            ...
                                            <li style="margin-left:10px;margin-right:10px;"><button
                                                    class="btn genric-btn small"
                                                    onclick="document.getElementById('modal-wrapper').style.display='block'">Login</button>
                                                <div id="modal-wrapper" class="modal">

                                                    <form methode="post" action="controller/loginControl.php" name="fpackage"
                                                        ...
                                                        <div class="imgcontainer">
                                                            ...
                                                            <img src="../assets/img/icon/login.jpg" alt="Avatar"
                                                                class="avatar"
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <input class="formbutton" type="submit" value="Submit"
                                                                name="sub" id="sub">
                                                            <input type="checkbox" style="margin:26px 30px;"> Remember
                                                            me
                                                            <a href="#"
                                                                style="text-decoration:none; float:right; margin-right:34px; margin-top:26px;">Forgot
                                                                Password ?</a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </li>
                                            <li><button class="btn genric-btn small"
                                                    onclick="document.getElementById('modal-wrapper1').style.display='block'">Register</button>
                                                <div id="modal-wrapper1" class="modal">


                                                    <form methode="post" action="controller/registerControl.php" name="fpackage"
                                                        class="modal-content animate">
                                                        ...
                                                        <div class="imgcontainer">
                                                            <span
                                                                ...
                                                                class="close" title="Close PopUp">&times;</span>
                                                            <img src="../assets/img/icon/register.jpg" alt="Avatar"
                                                                class="avatar"
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <input type="text" placeholder="Enter Email" name="email"
                                                                id="email">
                                                            <input type="text" placeholder="Mobile Number" name="mn"
                                                                id="mn">
                                                            <input type="password" placeholder="Enter Password"
                                                                name="psw" id="psw">
                        ...
                        <div class="footer-copy-right">
                            <p>
                                ...
                                template is made with <i class="ti-heart" aria-hidden="true"></i> by <a
                                    href="our_team.html" target="_blank">Colorlib</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
